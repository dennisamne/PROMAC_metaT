...
```{r}
#Trying the cowplot version to unify legends.
legend <- get_legend(
  # create some space to the left of the legend
  NvsC_NUp + theme(legend.box.margin = margin(0, 0, 0, 12))
)

p1 <- plot_grid(NvsC_CDown + theme(legend.position="none"),  NvsC_NUp + theme(legend.position="none"),  TvsC_TUp +  theme(legend.position="none"), TNvsT_TNUp) 

plot_grid(p1, legend, ncol = 1)
```
